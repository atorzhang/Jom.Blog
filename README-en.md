[ENGLISH](https://github.com/anjoy8/Jom.Blog/blob/master/README-en.md) | [中文版](https://github.com/anjoy8/Jom.Blog/blob/master/README.md)


![Logo](https://github.com/anjoy8/Jom.Blog/blob/master/Jom.Blog/wwwroot/logocore.png)
...
*********************************************************
# Tips: 
1. Jom.Blog.FrameWork project is a simple implementation of generating files using T4 templates.
...
1, in the Jom.Blog.Repository layer under the Sugar folder under the BaseDBConfig.cs, configure their own strings
``` 
...
```
2, in the Jom.Blog.FrameWork layer of the dbhelper.ttinclude, configure their own strings
``` 
...
Blog Park: https://www.cnblogs.com/laozhang-is-phi/
 ...
 Code Cloud: Https://gitee.com/laozhangIsPhi/Jom.Blog
